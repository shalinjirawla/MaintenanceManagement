...
namespace MaintenanceManagementApi.Data.Migrations
{
    ...
    [Migration("20241028102459_updatetblfeedback")]
    partial class updatetblfeedback
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaintenanceManagementApi.Data.DBModel.CustomerFeedback", b =>
                {
                    ...
                    b.HasOne("MaintenanceManagementApi.Data.DBModel.WorkOrder", "WorkOrderFeed")
                        .WithMany()
                        .HasForeignKey("WorkorderID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
