...
namespace MaintenanceManagementApi.Data.Migrations
{
    ...
    [Migration("20241018085956_workordertableadd")]
    partial class workordertableadd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaintenanceManagementApi.Data.DBModel.WorkOrder", b =>
                {
                    b.HasOne("MaintenanceManagementApi.Data.DBModel.WorkRequest", "workRequestedIdy")
                        .WithMany()
                        .HasForeignKey("RequestedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("workRequestedIdy");
                });
