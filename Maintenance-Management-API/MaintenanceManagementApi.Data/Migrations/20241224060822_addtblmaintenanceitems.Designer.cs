...
namespace MaintenanceManagementApi.Data.Migrations
{
    ...
    [Migration("20241224060822_addtblmaintenanceitems")]
    partial class addtblmaintenanceitems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaintenanceManagementApi.Data.DBModel.MaintenanceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CompletedWorkOrderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompletedWorkOrderId");
            ...
            modelBuilder.Entity("MaintenanceManagementApi.Data.DBModel.MaintenanceItem", b =>
                {
                    b.HasOne("MaintenanceManagementApi.Data.DBModel.CompletedWorkOrder", "CompletedWorkOrder")
                        .WithMany()
                        .HasForeignKey("CompletedWorkOrderId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("CompletedWorkOrder");
                });
